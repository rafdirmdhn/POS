...
<head>
    ...
    <title>Login Aplikasi Kasir | by.OptimizaPOS</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/OptimizaPOS.png" alt="" width="72" height="72">
      ...
      <p class="mt-3 mb-3 text-grey">&copy; 2023 Developed by - <a target="_blank" rel="noopener noreferrer" class="text-grey">
     OptimizaPOS</a></p>
    </form>
